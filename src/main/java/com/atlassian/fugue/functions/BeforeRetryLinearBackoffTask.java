...
public class BeforeRetryLinearBackoffTask implements Runnable
{
    ...
    /**
     * This method causes the current thread to sleep for the time specified
     * when the instance is constructed. InterruptedExceptions are wrapped
     * before being rethrown in a RuntimeException.
     */
    public void run()
    {
        try
