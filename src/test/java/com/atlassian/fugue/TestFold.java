...
public class TestFold {
  @Test public void testF2FoldBasic() {
    Function2<Integer, Integer, Integer> add = new Function2<Integer, Integer, Integer>() {
      @Override public Integer apply(Integer arg1, Integer arg2) {
        return arg1 + arg2;
      }
    };
  ...
  @Test public void testF2FoldTypes() {
    Function2<String, Integer, String> displayIterable = new Function2<String, Integer, String>() {
      @Override public String apply(String arg1, Integer arg2) {
        return arg1 + "  " + arg2;
      }
    };
  ...
  @Test public void testF1FoldTypes() {
    Function<Pair<String, Integer>, String> displayIterable = new Function<Pair<String, Integer>, String>() {
      @Override public String apply(Pair<String, Integer> t) {
