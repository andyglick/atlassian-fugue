...
public class ApplicativeFunction {
  ...
  @Test public void functionApplication() {
    assertThat(Functions.ap(f, g).apply(1), is(true));
  }

  @Test public void functionApplicationSwitching() {
    assertThat(Functions.ap(f, g).apply(2), is(true));
  }

  @Test(expected = NullPointerException.class) public void functionApplicationNullContext() {
    Functions.ap(f, null).apply(2);
  }

  @Test(expected = NullPointerException.class) public void functionApplicationNullStart() {
    Functions.ap(null, g).apply(2);
  }

  @Test(expected = NullPointerException.class) public void functionApplicationAllNull() {
