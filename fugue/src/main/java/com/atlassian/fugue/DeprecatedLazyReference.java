 ...
 */
abstract class DeprecatedLazyReference<T> extends WeakReference<T> implements Supplier<T> {

  private final Sync sync = new Sync();

  public DeprecatedLazyReference() {
    super(null);
  }
  ...
  /**
   * If the factory {@link DeprecatedLazyReference#create()} method threw an exception,
   * this wraps it.
   */
